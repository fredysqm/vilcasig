...
function postLoading() {
    ...
    if (!initialLoadDone) {
        ...
        coordinateTextField.on('specialkey', function (textField, evt) {
            if (evt.getKey() == evt.ENTER) {
                ...
                //var newCenter = new OpenLayers.LonLat(parseFloat(-8107965), parseFloat(-1504259));
    ...
    if (!initialLoadDone) {
        ...
        var zoomBoxAction = new GeoExt.Action({
            icon: '/static/img/gis_icons/mActionZoomBox.png',
            id: 'navZoomBoxButton',
            scale: 'medium',
        ...
        var zoomToPreviousAction = new GeoExt.Action({
            icon: '/static/img/gis_icons/mActionZoomLast.png',
            scale: 'medium',
        ...
        var zoomToNextAction = new GeoExt.Action({
            icon: '/static/img/gis_icons/mActionZoomNext.png',
            scale: 'medium',
        ...
        if (useGeoNamesSearchBox || searchBoxQueryURL != null) {
            ...
            if (useGeoNamesSearchBox) {
                ...
                var emptySearchFieldButton = new Ext.Button({
                    scale: 'medium',
                    icon: '/static/img/gis_icons/mActionUndo.png',
                    tooltipType: 'qtip',
