# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2016-12-13 18:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('porcentaje', models.DecimalField(decimal_places=2, help_text='Porcentaje de habitantes que laboran en el centro de trabajo', max_digits=3, verbose_name='Porcentaje')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(help_text='Tipo de centro de trabajo', on_delete=django.db.models.deletion.CASCADE, to='item.TipoCentroTrabajo', verbose_name='Centro de trabajo'),
        ),
    ]
